...
from tools_paddle.infer.utility import base64_to_cv2
from tools_paddle.infer.predict_rec import TextRecognizer
from tools_paddle.infer.utility import parse_args
